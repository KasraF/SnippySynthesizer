...
import edu.ucsd.snippy.ast.{ASTNode, IntLiteral, StringConcat, StringLiteral, StringNode, StringStringMapCompNode, StringVariable, Types}
import edu.ucsd.snippy.enumeration.{Contexts, InputsValuesManager, ProbEnumerator}
import org.junit.Test
import org.scalatestplus.junit.JUnitSuite
import org.junit.Assert._
import edu.ucsd.snippy.enumeration.ProbUpdate.priors
...
class NestedEnumerator extends JUnitSuite {
  ...
  @Test def enumerateVocabNoOE: Unit = {
    ...
    val enumerator =
	    new ProbEnumerator(task.vocab, oeManager, task.contexts, false, false, 0, bank, bank)
